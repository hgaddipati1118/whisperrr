...
'q','r','s','t','u','v','w','x','y','z'];
export default function McOption({option, index, value, setValue, clearHove}){
    ...
    return(
        <div className= {`flex bg-cyan-400 ${value == option.choiceVal?"md:bg-cyan-800":" "} md:hover:bg-cyan-800 mb-5 
